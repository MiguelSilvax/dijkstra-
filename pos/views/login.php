                                    ...
                                    <div class="form-body">
                                        <form class="row g-3" id="formulario" method="POST" autocomplete="off">
                                            <div class="col-12">
                                                ...
                                                <div id="errorUsuario" class="alert alert-danger mt-2"></div>
                                            </div>
                                            <div class="col-12">
                                                ...
                                                <div id="errorClave" class="alert alert-danger mt-2"></div>
                                            </div>

                                            <div class="col-md-12 text-end"> <a href="authentication-forgot-password.html">Olvidé mi contraseña</a>
                                            </div>
                                            <div class="col-12">
                                                <div class="d-grid">
